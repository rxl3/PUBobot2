...
@groups.admin_testing.subcommand(name='rcon_cmd', description='Send rcon command')
async def _rcon_cmd(
	interaction: Interaction,
	rcon_string: str,
	cmd: str
	...
	await run_slash(bot.commands.rcon_cmd, interaction=interaction, rcon_str=rcon_string, cmd=cmd)
